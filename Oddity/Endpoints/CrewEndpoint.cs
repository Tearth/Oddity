...
namespace Oddity.Endpoints
{
    ...
    /// </summary>
    public class CrewEndpoint<T> : EndpointBase<T> where T : ModelBase, IIdentifiable, new()
    {
        /// <summary>
        ...
        {
            return new SimpleBuilder<T>(Context, Cache, "crew", id);
        }
        ...
        {
            return new ListBuilder<T>(Context, Cache, "crew");
        }
        ...
        {
            return new QueryBuilder<T>(Context, Cache, "crew/query");
        }
    }
}